            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <h1>Layani dengan serius dengan <em>kasir</em></h1>
                        <p>Kasir adalah website untuk mendata produk yang keluar masuk serta merangkai sistem karyawan dengan akses yang cepat, mudah, dan praktis</p>
                        <a href="#about" class="main-button-slider">Masuk</a>
                    </div>
                </div>
            </div>
        </div>
